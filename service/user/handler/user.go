...
import (
	...
	"ihomeMs/service/user/model"
	user "ihomeMs/service/user/proto/user"
	"ihomeMs/service/user/utils"
)

type User struct{}

// MicroGetUser Call is a single request handler called via client.Call or the generated client code
func (e *User) MicroGetUser(ctx context.Context, req *user.Request, rsp *user.Response) error {
	...
	userInfo.AvatarUrl = "http://47.94.195.58:8888/" + myUser.Avatar_url
...
func (e *User) UploadAvatar(ctx context.Context, req *user.UploadReq, resp *user.UploadResp) error {
	...
	uploadData.AvatarUrl = "http://47.94.195.58:8888/" + fdfsResp
