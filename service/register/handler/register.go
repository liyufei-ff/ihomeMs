...
import (
	...
	"ihomeMs/service/register/utils"
)

type Register struct{}

// SmsCode 短信验证码
func (e *Register) SmsCode(ctx context.Context, req *register.Request, resp *register.Response) error {
	...
	//request.QueryParams["SignName"] = "ihome"    //签名名称   需要申请
	...
	//}
	//存储短信验证码  存redis中 申请短信验证码接口失败使用假数据代替
	err = model.SaveSmsCode(req.Mobile, "233333")
	if err != nil {
